...
\begin{figure}
    \centering
    \includegraphics[width=0.85\linewidth]{./fig/law_J.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.85\linewidth]{./fig/law_US.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.85\linewidth]{./fig/law_USstate.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.85\linewidth]{./fig/law_EU.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.85\linewidth]{./fig/law_PRC.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.85\linewidth]{./fig/case_CJEU.png}
    \caption{欧州司法裁判所判決の入力例。}
    \label{fig:case_cjeu}
\end{figure}

\subsubsection{その他の国・地域の判決}
権利に「Jcase」「EUcase」「Jdiet（\ref{ssec:jdiet}節参照）」以外の文字列（大文字・小文字違いや空欄も含む）を入力すると
...
\subsection{国会議事録}
\label{ssec:jdiet}
アイテムは「公聴会」を選択した上で、「権利」にJdietという文字列を入力してください。
