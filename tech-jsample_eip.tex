...
\begin{figure}
    \centering
    \includegraphics[width=0.85\linewidth]{./fig/doi.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.85\linewidth]{./fig/article_j.png}
    \caption{和文論文での入力例。}
    \label{fig:article_j}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.85\linewidth]{./fig/book_j.png}
    \caption{和文書籍での入力例。}
    \label{fig:book_j}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.85\linewidth]{./fig/book-chapter_j.png}
    \caption{和文書籍の章での入力例。}
...
\begin{figure}
    \centering
    \includegraphics[width=0.85\linewidth]{./fig/proceedings_j.png}
    \caption{学会発表の入力例。}
...
\subsection{法}
アイテムは「法律」を選択します。
抄録欄への入力内容で引用形式を振り分けています。現在対応している法と抄録への入力内容は、
\begin{description}
    \item [日本法] Jlaw
    \item [米国連邦法] USlaw
...
\begin{figure}
    \centering
    \includegraphics[width=0.85\linewidth]{./fig/Jlaw.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.85\linewidth]{./fig/USlaw.png}
...
\begin{itemize}
    ...
    \item 抄録にUSstatelawと入力
\end{itemize}
\cite{ccpa2018}のように引用されます。

\begin{figure}
    \centering
    \includegraphics[width=0.85\linewidth]{./fig/USstatelaw.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.85\linewidth]{./fig/EUlaw.png}
...
抄録に上記以外の値を入力（大文字・小文字違いや空欄を含む）すると(図\ref{fig:prclaw})、
デフォルトの引用形式
\cite{pipl2021}
が出力されます。
...
\begin{figure}
    \centering
    \includegraphics[width=0.85\linewidth]{./fig/PRClaw.png}
    \caption{その他国・地域の法(中華人民共和国個人情報保護法)の入力例。抄録に入力された「PRClaw」は無視され、
    デフォルトの引用形式で出力される。}
    \label{fig:prclaw}
\end{figure}
...
アイテムを「訴訟」にします。
抄録やレポーター、リポーター巻への入力内容で引用形式を振り分けています。
...
\begin{figure}
    \centering
    \includegraphics[width=0.85\linewidth]{./fig/case_japan_reported.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.85\linewidth]{./fig/case_japan_notreported.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.85\linewidth]{./fig/case_japan_db.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.85\linewidth]{./fig/caseCJEU.png}
    \caption{欧州司法裁判所判決の入力例。}
    \label{fig:case_cjeu}
\end{figure}

\subsubsection{その他の国・地域の判決}
抄録に「Jcase」「EUcase」「Jdiet（\ref{ssec:jdiet}節参照）」以外の文字列（大文字・小文字違いや空欄も含む）を入力すると
...
\begin{figure}
    \centering
    \includegraphics[width=0.85\linewidth]{./fig/case_other.png}
    \caption{その他の国・地域判決の入力例。抄録に入力された「Francecase」は無視され、
    デフォルトの引用形式で出力される。}
...
\subsection{国会議事録}
\label{ssec:jdiet}
アイテムは「公聴会」を選択した上で、「抄録」にJdietという文字列を入力してください。
...
\begin{itemize}
    ...
    \item 抄録に「Jdiet」
\end{itemize}
です(図\ref{fig:diet_j})。これによって\cite{Dai156Kai2003o}のように出力されます。

\begin{figure}
    \centering
    \includegraphics[width=0.85\linewidth]{./fig/diet_j.png}
    \caption{国会議事録の入力例。}
    \label{fig:diet_j}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.85\linewidth]{./fig/webpage.png}
    \caption{Webページの入力例。}
    \label{fig:webpage}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.85\linewidth]{./fig/adh.png}
